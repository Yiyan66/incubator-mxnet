...
_bin_logic_op_map = {
    ...
    'logical_and': lambda a, b, *idx: tvm.all(a[idx]==1,b[idx]==1),
    'logical_or': lambda a, b, *idx: tvm.any(a[idx]==1,b[idx]==1),
    'logical_xor': lambda a, b, *idx: tvm.all(tvm.any(a[idx]==1,b[idx]==1),tvm.any(a[idx]==0,b[idx]==0)),
}
...
_bin_scalar_logic_op_map = {
    ...
    'logical_and_scalar': lambda a, b, *idx: tvm.all(a[idx].astype(b.dtype)==1,b[idx]==1),
    'logical_or_scalar': lambda a, b, *idx: tvm.any(a[idx].astype(b.dtype)==1,b[idx]==1),
    'logical_xor_scalar': lambda a, b, *idx: tvm.all(tvm.any(a[idx].astype(b.dtype)==1,b[idx])==1,tvm.any(a[idx].astype(b.dtype)==0,b[idx]==0)),
}
